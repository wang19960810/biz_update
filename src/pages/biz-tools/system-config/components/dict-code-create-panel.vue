...
const queryDictCodes = async () => {
  ...
  try {
    ...
    // 固定使用 newlyAddedDictCodeData（可新增的数据）
    const sourceData = dictCodeStore.newlyAddedDictCodeData
...
<template>
  <section class="workspace-card">
    <div class="workspace-header">
      <div>
        <p class="workspace-kicker">Add Dictionary</p>
        <h2>新增字典</h2>
      </div>
      ...
      <div class="workspace-panel">
        <div class="query-toolbar">
          ...
          <div class="query-actions">
            <el-button type="primary" :loading="tableLoading" @click="queryDictCodes">查询可新增字典</el-button>
