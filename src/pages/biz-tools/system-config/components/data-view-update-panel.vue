...
const selectedCodes = computed(() => selectedRows.value.map(item => item.code))
      ...
      <div class="workspace-panel">
        <div class="query-toolbar">
          <div class="query-fields">
            ...
            <div class="field-item field-item-keyword">
              <p class="section-label">关键字筛选</p>
              <el-input
                v-model="keyword"
        ...
        <div class="summary-panel">
          <div class="summary-item">
            <span>查询系统</span>
            <strong>{{ effectiveQuerySystems.length }}</strong>
          </div>
          <div class="summary-item">
            <span>查询结果</span>
            <strong>{{ queriedCount }}</strong>
          </div>
          <div class="summary-item">
            <span>勾选条数</span>
        ...
        <div class="table-toolbar">
          <div>
            ...
            <strong>{{ filteredTableData.length ? `共 ${filteredTableData.length} 条` : '暂无数据' }}</strong>
          </div>
        ...
        <template v-else>
          ...
          <div class="table-footer">
            <p v-if="selectedCodes.length" class="selection-hint">
              已选 {{ selectedCodes.length }} 项：{{ selectedCodes.join('，') }}
            </p>
